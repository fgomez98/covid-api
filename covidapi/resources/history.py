...
from covidapi.models.stats import StatsHistorial
from covidapi.resources.resource_handlers import summary_history
from covidapi.resources.resource_utils import parameters, filters_get_args, pUtf8


class History(Resource):
    @swagger.operation(responseClass=StatsHistorial.__name__, parameters=parameters)
    @marshal_with(StatsHistorial.resource_fields)
    def get(self):
